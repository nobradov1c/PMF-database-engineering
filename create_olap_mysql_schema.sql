...
-- -----------------------------------------------------
-- Table `libraryOLAP`.`Customer_DW`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `libraryOLAP`.`Customer_DW` (
  ...
  CONSTRAINT `fk_Customer_ActiveMembership1`
    ...
    REFERENCES `libraryOLAP`.`ActiveMembership_DW` (`idActiveMembership`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `libraryOLAP`.`RentedBook_DW` (
  ...
  CONSTRAINT `fk_RentedBook_Customer1`
    ...
    REFERENCES `libraryOLAP`.`Customer_DW` (`idCustomer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
